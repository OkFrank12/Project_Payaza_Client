    ...
    <div className="w-full h-screen flex items-center justify-center "> 
        <div className="w-[80%] h-[80%] max-sm:h-[90%] flex justify-between max-sm:flex-col" >
            <div className="w-[45%]  max-sm:w-[100%]">
                <img src={img} alt="" className="w-[100%] h-[100%] bg-[#eeeeeef4] object-fill"/>
            </div>
            <div className="w-[50%] max-sm:w-[100%]">
                <div className="text-[20px] font-semibold tracking-widest">Solid Cargo Pant</div>
           
                <div className="relative h-[20px] w-[100%]">
                <div className="text-[13px] absolute z-[1] top-0 left-0">{"⭐".repeat(4)}</div>
                ...
                <div>
                    ...
                    <h3 className="text-[15px] md:text-[14px]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Cum esse fugiat iure, vel dolorum aut quasi quas itaque!</h3>
                </div>
                <br/>
